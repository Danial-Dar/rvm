...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
      ...
      return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              baseUrl = "/nova-api/custom/get-bot-user/" + _this.id;
              _context.next = 3;
              return Nova.request().get(baseUrl).then(function (response) {
                console.log(response.data.user_id, 'first pe ye ana chahiye');
                _this.userId = btoa(response.data.user_id);
                _this.portNumber = btoa(response.data.port_number);
                _this.assignValues();
              });
            case 3:
            case "end":
    ...
    assignValues: function assignValues() {
      this.botId = btoa(this.id);
      this.srcLink = "https://gleaming-donut-c1e6b4.netlify.app/" + this.userId + "/" + this.botId + "/" + this.portNumber;
      console.log(this.botId, '--------------botID----------');
      console.log(this.userId, '--------------userID----------');
      console.log(this.srcLink, '--------------link----------');
      console.log(this.portNumber, '--------------PortNumber----------');
    }
  }
});
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("div", null, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)(" <Head title=\"Bot Train\" />\n\n    <Heading class=\"mb-6\">Bot Train</Heading> "), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createVNode)(_component_Card, {
    ...
    "default": (0,vue__WEBPACK_IMPORTED_MODULE_0__.withCtx)(function () {
      return [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_1, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("iframe", {
...
Nova.booting(function (app, store) {
  ...
  Nova.inertia('bot-train/{id}', _pages_Tool__WEBPACK_IMPORTED_MODULE_0__["default"]);
});
...
/* harmony import */ var _Users_adnansalahuddin_Source_Code_rvm_laravel_nova_components_BotTrain_node_modules_vue_loader_dist_exportHelper_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./node_modules/vue-loader/dist/exportHelper.js */ "./node_modules/vue-loader/dist/exportHelper.js");
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkrvm_bot_train"] = self["webpackChunkrvm_bot_train"] || [];
