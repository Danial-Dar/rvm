                ...
                <div v-show="currentStep === 0" class="step">
                    ...
                    <div class="">
                        ...
                        >
                            ...
                            /> -->
                            <Multiselect
                                v-model="receive_response"
                                placeholder="Select Receive Response"
                                :options="receive_response_option"
                                :searchable="true"
                                ref="multiselect"
                                required
                            />
...
export default {
    ...
    data() {
        return {
            totalSteps: 4,
            currentStep: 0,
            routePrefix: "/nova-vendor/sms-compaign-builder",
            link: {
                ...
                .then((response) => {
                    ...
                    if (response.status == 200) {
                        if (response.data.status == "success") {
                            ...
                            Nova.visit("/resources/sms-compaigns");
                        } else {
