   ...
   <div class="crm">
      <div class="container-fluid">
         ...
         <div class="loader" id="reportLoader" style="display: none;">
          ...
          <div class="row">
               ...
               <div class="ap-po-details ap-po-details--2 p-25 radius-xl bg-white d-flex justify-content-between">
                  <div>
                     <div class="overview-content">
                        <h1 id="total_users">{{count($users)}}</h1>
                        <p>Total Users</p>
                     </div>
                  </div>
            ...
            <div class="col-xxl-3 col-sm-3  col-ssm-6 mb-30">
               ...
               <div class="ap-po-details ap-po-details--2 p-25 radius-xl bg-white d-flex justify-content-between">
                  <div>
                     <div class="overview-content">
                        <h1 id="total_campaigns">{{count($campaignsCounter)}}</h1>
                        <p>Total Campaigns</p>
                     </div>
                  </div>
               </div>
            ...
            <div class="col-xxl-3 col-sm-3  col-ssm-6 mb-30">
               <div class="ap-po-details ap-po-details--2 p-25 radius-xl bg-white d-flex justify-content-between">
                  <div>
                     <div class="overview-content">
                     <h1 id="total_contact_lists">{{$contact_lists}}</h1>
            ...
            <div class="col-xxl-3 col-sm-3  col-ssm-6 mb-30">
               ...
               <div class="ap-po-details ap-po-details--2 p-25 radius-xl bg-white d-flex justify-content-between">
                  <div>
                     <div class="overview-content">
                        <h1 id="total_pending">{{$totalPending}}</h1>
                        <p>Total Pending</p>
                     </div>
                  </div>
               </div>
            ...
            <div class="col-xxl-3 col-sm-3  col-ssm-6 mb-30">
               ...
               <div class="ap-po-details ap-po-details--2 p-25 radius-xl bg-white d-flex justify-content-between">
                  <div>
                     <div class="overview-content">
                        <h1 id="total_reccording">{{$total_recording}}</h1>
          ...
          <div class="row">
             <div class="col-lg-12 mb-20">
               <select name="user-select" id="user-select" class="form-control" style="width:25%" onchange="showHideGraphs()">
          ...
          <div class="row" id="dateRangePickerDiv" style="display: none;">
            <div class="col-lg-4 mb-20">
                <input type="text" name="datetimes" class="form-control" placeholder="Select Date Range" />
             </div>
          </div>
         <div class="row ">            
             <div class="col-xl-6 col-md-6 mb-30" id="content_first" style="display: none;">
               <div class="card broder-0 cashflowChart2">
                  <div class="card-header">
                     <h6>
                        Campaigns & Api Status
                     </h6>
                           ...
                           <div class="cashflow-chart">
                                 ...
                                 <div class="page-content page-container" id="page-content">
                                       <div class="row">
                                             <div class="container-fluid d-flex justify-content-center">
                                                <div class="col-sm-12 col-md-12" id="canvasOne">
                            ...
                            {{--   <ul class="legend-static ml-2">
                                 <li class="custom-label">
                                    <span class="bg-success"></span>Campaigns Completed
                                 </li>
                              </ul> --}}
                           </div>
                        </div>
             ...
             <div class="col-xl-6 col-md-6 mb-30" id="content_third" style="display: none;">
                 <div class="card broder-0 cashflowChart2">
                    <div class="card-header">
                       <h6>
                          Contact List
           ...
           {{-- <div class="row">
               <div class="col-xl-12 col-md-12 mb-30" id="api_content" style="display: none;">
                 <div class="card broder-0 cashflowChart2">
                    <div class="card-header">
                       <h6>
                          API Status
                                   ...
                                   <div class="page-content page-container" id="page-content">
                                         <div class="row">
                                               <div class="container-fluid d-flex justify-content-center">
                                                  ...
                                                  <div class="col-sm-8 col-md-4"  id="canvasApiStatus">
                                                     <div class="chartjs-size-monitor" style="position: absolute; left: 0px; top: 0px; right: 0px; bottom: 0px; overflow: hidden; pointer-events: none; visibility: hidden; z-index: -1;">
                                                        <div class="chartjs-size-monitor-expand" style="position:absolute;left:0;top:0;right:0;bottom:0;overflow:hidden;pointer-events:none;visibility:hidden;z-index:-1;">
                                                              <div style="position:absolute;width:1000000px;height:1000000px;left:0;top:0"></div>
                                                        </div>
                                                     ...
                                                     <canvas id="chart-line-pie-api" width="299" height="200" class="chartjs-render-monitor" style="display: block; width: 299px; height: 200px;"></canvas>
                                                  </div>
                                               </div>
                                         </div>
                                   </div>
                              ...
                              <div class="parentContainer">
                                 <div>
                                    <div class="page-content page-container" id="page-content">
                                       <div class="row">
                                             <div class="container-fluid d-flex justify-content-center">
                                                <div class="col-sm-8 col-md-12" id="CanvasContactInformation">
                                                      <div class="chartjs-size-monitor" style="position: absolute; left: 0px; top: 0px; right: 0px; bottom: 0px; overflow: hidden; pointer-events: none; visibility: hidden; z-index: -1;">
                                                         <div class="chartjs-size-monitor-expand" style="position:absolute;left:0;top:0;right:0;bottom:0;overflow:hidden;pointer-events:none;visibility:hidden;z-index:-1;">
                                                               <div style="position:absolute;width:1000000px;height:1000000px;left:0;top:0"></div>
                                                         </div>
         ...
         <div class="row">
              <div class="col-xl-12 col-md-12 mb-30" id="content_sixth" style="display: none;">
                 <div class="card broder-0 cashflowChart2">
                    <div class="card-header">
                       <h6>
                                ...
                                <div class="parentContainer">
                                   <div>
                                      <div class="page-content page-container" id="page-content">
                                         <div class="row">
                                               <div class="container-fluid d-flex justify-content-center">
                                                  <div class="col-sm-8 col-md-12" id="canvasSixth">
                                                        <div class="chartjs-size-monitor" style="position: absolute; left: 0px; top: 0px; right: 0px; bottom: 0px; overflow: hidden; pointer-events: none; visibility: hidden; z-index: -1;">
                                                           <div class="chartjs-size-monitor-expand" style="position:absolute;left:0;top:0;right:0;bottom:0;overflow:hidden;pointer-events:none;visibility:hidden;z-index:-1;">
                                                                 <div style="position:absolute;width:1000000px;height:1000000px;left:0;top:0"></div>
                                                           </div>
                                                        ...
                                                        </div> <canvas id="chart-line-bar-sixth" width="299" height="200" class="chartjs-render-monitor" style="display: block; width: 299px; height: 200px;"></canvas>
            ...
            <div class="row">
              <div class="col-xl-12 col-md-12 mb-30" id="content_seventh" style="display: none;">
                 <div class="card broder-0 cashflowChart2">
                    <div class="card-header">
                       <h6>
                          Api Status
                                ...
                                <div class="parentContainer">
                                   <div>
                                      <div class="page-content page-container" id="page-content">
                                         <div class="row">
                                               <div class="container-fluid d-flex justify-content-center">
                                                  <div class="col-sm-8 col-md-12" id="canvasSeventh">
                                                        <div class="chartjs-size-monitor" style="position: absolute; left: 0px; top: 0px; right: 0px; bottom: 0px; overflow: hidden; pointer-events: none; visibility: hidden; z-index: -1;">
                                                           <div class="chartjs-size-monitor-expand" style="position:absolute;left:0;top:0;right:0;bottom:0;overflow:hidden;pointer-events:none;visibility:hidden;z-index:-1;">
                                                                 <div style="position:absolute;width:1000000px;height:1000000px;left:0;top:0"></div>
                                                           </div>
                                                        ...
                                                        </div> <canvas id="chart-line-bar-seventh" width="299" height="200" class="chartjs-render-monitor" style="display: block; width: 299px; height: 200px;"></canvas>
...
<script type="text/javascript">
   function campaignInitiatedPerHour(date){
    ...
    $.ajax({
        url: '{{route('admin.reports.per_hour_results')}}',
        contentType: "application/json; charset=utf-8", 
        data:{drops_per_hour_date: selected_date,user_id:user_id},
...
<script>
   function graphs(list_names,list_contacts,played_campaigns,paused_campaigns,inactive_campaigns,finished_campaigns,successful, initiated, pending, fail,sent,campaignInitiated,datesArray,campaignInitiatedPerHour,dropsPerHourArray,campaignNames) {

         
      var pie_second = $("#chart-line");
      var myPieSecond = new Chart(pie_second, {
            type: 'pie',
            data: {
               // labels: ["Playing", "Paused", "InActive", "Finished"],
               labels: ["Successfull", "Initiated", "Failed"], //, "Pending"
                datasets: [{
                   // data: [1850, 1850, 1850],
                   // data: [played_campaigns, paused_campaigns, inactive_campaigns, finished_campaigns],
      ...
      var myBarGraph = new Chart(bar_graph, {
       ...
       var myBarGraphFourth = new Chart(bar_graph_fourth, {
             ...
             data: {
                ...
                labels: Object.values(datesArray),
                //  labels: list_contacts,
                datasets: [{
                   //   data: [50000, 100000, 150000, 200000, 250000, 300000, 350000, 400000, 450000, 500000, 550000, 600000, 650000, 700000, 750000, 800000, 850000, 900000, 950000, 1000000],
                   data: Object.values(campaignInitiated),
       ...
       var bar_graph_sixth = $("#chart-line-bar-sixth");
       var myBarGraphSixth = new Chart(bar_graph_sixth, {
             type: 'line',
             data: {
               
                labels: Object.values(campaignNames),
       ...
       var bar_graph_seventh = $("#chart-line-bar-seventh");
       var myBarGraphSeventh = new Chart(bar_graph_seventh, {
             type: 'line',
             data: {
...
async function showHideGraphs(start_date,end_date) {
   // response = await axios.get('/rvm-laravel/admin/reports/results/'+element.value);
  $('#dateRangePickerDiv').css('display','block');
   var element = document.getElementById('user-select');
   var x = element.value;
   var url = '<?php echo url('admin/reports/results/') ?>';
   ...
   var total_campaigns = response.data.total_campaigns;
   var played_campaigns = response.data.played_campaigns;
   var paused_campaigns = response.data.paused_campaigns;
   var inactive_campaigns = response.data.inactive_campaigns;
   var finished_campaigns = response.data.finished_campaigns;
   var campaignNames = response.data.campaignNames;
   ...
   var datesArray = response.data.datesArray;
   ...
   var dropsPerHourArray = response.data.dropsPerHourArray;
    ...
    $("#chart-line").remove();
    $('#canvasOne').append('<canvas id="chart-line" class="chartjs-render-monitor" style="display: block;"></canvas>');

    $("#chart-line-bar-sixth").remove();
    $('#canvasSixth').append(' <canvas id="chart-line-bar-sixth" width="299" height="200" class="chartjs-render-monitor" style="display: block; width: 299px; height: 200px;"></canvas>');
    


    // $("#chart-line-bar").remove();
    // $('#CanvasContactInformation').append('<canvas id="chart-line-bar" width="299" height="200" class="chartjs-render-monitor" style="display: block; width: 299px; height: 200px;"></canvas>');

    $("#chart-line-bar-fourth").remove();
    ...
    $("#chart-line-bar-seventh").remove();
    $('#canvasSeventh').append('<canvas id="chart-line-bar-seventh" width="299" height="200" class="chartjs-render-monitor" style="display: block; width: 299px; height: 200px;"></canvas>');
    

   graphs(list_names,list_contacts,played_campaigns,paused_campaigns,inactive_campaigns,finished_campaigns,successful, initiated, pending, fail,sent,campaignInitiated,datesArray,campaignInitiatedPerHour,dropsPerHourArray,campaignNames);
   ...
   document.getElementById("content_sixth").style.display = element.value != "" ? 'block' : 'none';
   document.getElementById("content_seventh").style.display = element.value != "" ? 'block' : 'none';
