...
<script>
    async function companyFunction(){
        ...
        $('#all_user').hide();
        $('#specific_user').hide();
        // console.log(baseUrl+'/company/'+x)
        if (x == "all") {
            $('.loader').show()
            await axios.get(baseUrl+'/company/'+x)
            .then((response) => { 
                if(response.data){
                ...
                if(response.data){
                    ...
                    Object.keys(response.data).forEach(function(key) {
                        $('#user').append($('<option>', { 
                            ...
                            text : response.data[key].first_name, 
                        }));   
                    });
                    $('.loader').hide()
                }
    ...
    async function userFunction(){
        ...
        if (x == "all") {
            ...
            $('#specific_user').hide()
            $('.loader').show()
            await axios.get(baseUrl+'/user/'+x+'/'+y)
            .then((response) => { 
                if(response.data){
                    console.log(response.data);
                    $('#all_user').show();
