       ...
       <div class="container-fluid">
          <div class="row">
             <div class="col-lg-12 mb-20">
                <div class="breadcrumb-main">
                   <h4 class="text-capitalize breadcrumb-title">Callzy Sms Reports</h4>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 mb-20">
                        <select name="camapign_select" id="camapign_select" class="form-control" onchange="fetchReportData()">
                            ...
                            @foreach($sms_campaign as $campaign)
                    ...
                    <div class="col-lg-4 mb-20">
                        <select name="list_select" id="list_select" class="form-control" onchange="fetchReportData()">
                            ...
                            @foreach($sms_contact_lists as $list)
        ...
        <div class="row">
            ...
            <div class="col-xxl-3 col-sm-3 mb-30">
                <div class="ap-po-details ap-po-details--2 p-25 radius-xl bg-white d-flex justify-content-between">
                    <div>
                    <div class="overview-content">
                        <h1 id="inbound_sms_per_second">0</h1>
                        <p>Inbound Sms Per Second</p>
                    </div>
                    </div>
            ...
            <div class="col-xxl-3 col-sm-3 mb-30">
                <div class="ap-po-details ap-po-details--2 p-25 radius-xl bg-white d-flex justify-content-between">
                    <div>
                    <div class="overview-content">
                        <h1 id="outgoing_sms_per_second">0</h1>
                        <p>Outgoing Sms Per Second</p>
                    </div>
                    </div>
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-lg-12 mb-20">
                        ...
                        <div class="heat_map" id="opt-out-head-map"></div>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-lg-12 mb-20">
                        ...
                        <div class="heat_map" id="opt-in-head-map"></div>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-6" id="canvasOne">
                <div class="card">
                    <div class="card-header">
                        <h1>No of Texts Per campaign</h1>
                    </div>
                    <div class="card-body">
                            ...
                            <table id="campaignSpecificStatsTable" class="table table-striped table-bordered" style="width:100%">
                                <thead>
                                    <tr class="userDatatable-header">
                                        ...
                                        <th>
                                            <span class="userDatatable-title">Successful#(%)</span>
                                        </th>
                                        <th>
        ...
        <div class="row">
                        ...
                        <div class="table-responsive" id="recordingSpecificStatsTableDiv">
                            <table id="recordingSpecificStatsTable" class="table table-striped table-bordered" style="width:100%">
                                <thead>
                                    <tr class="userDatatable-header">
                                        <th>
                                            <span class="userDatatable-title">List</span>
                                        </th>
                                        <th>
                                            <span class="userDatatable-title">Sent</span>
                                        </th>
                                        <th>
                                            <span class="userDatatable-title">Delivered# (%)</span>
                                        </th>
                                        <th>
                                            <span class="userDatatable-title">Failure# (%)</span>
                                        </th>
                                    </tr>
                                </thead>
                                <tbody>
            ...
            <div class="col-md-6" id="canvasOne">
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="stateSpecificStatsLoader" id="" style="display:none;position:relative;top:5rem">
                            <div class="text-center">
                                <div class="spinner-border" role="status">
                                    <span class="sr-only">Loading...</span>
                                </div>
                        ...
                        <div class="table-responsive" id="statesSpecificStatsTableDiv">
                            <table id="statesSpecificStatsTable" class="table table-striped table-bordered" style="width:100%">
                                <thead>
                                    <tr class="userDatatable-header">
                                        <th>
                                        ...
                                        <th>
                                            <span class="userDatatable-title">Call Backs</span>
                                        </th>
                                        <th>
                                            <span class="userDatatable-title">Avg Call Duration</span>
                                        </th>
                                    </tr>
                                </thead>
                                <tbody>
        ...
        <div class="row">
            <div class="col-md-12" id="canvasOne">
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="carrierSpecificStatsLoader" id="" style="display:none;position:relative;top:5rem">
                            <div class="text-center">
                                <div class="spinner-border" role="status">
                                    <span class="sr-only">Loading...</span>
                                </div>
                        ...
                        <div class="table-responsive" id="carrierSpecificStatsTableDiv">
                            <table id="carrierSpecificStatsTable" class="table table-striped table-bordered" style="width:100%">
                                <thead>
                                    <tr class="userDatatable-header">
                                        <th>
                                            <span class="userDatatable-title">Carrier</span>
                                        </th>
                                        <th>
                                            <span class="userDatatable-title">Sent</span>
                                        </th>
...
@if(auth()->user()->role =="user")
    <input type="hidden" id="getReportCounterDataURL" value="{{route('user.sms_reports.counters')}}"/>
    <input type="hidden" id="getReportSendRatesPerDayDataURL" value="{{route('user.sms_reports.get_send_rates_per_day')}}"/>
    <input type="hidden" id="getReportCallbackPieChartDataURL" value="{{route('user.sms_reports.get_callback_pie')}}"/>
    <input type="hidden" id="getReportCallbackDurationHeatMapDataURL" value="{{route('user.sms_reports.get_call_back_duration')}}"/>
    <input type="hidden" id="getReportCallbackHeatMapDataURL" value="{{route('user.sms_reports.get_callback_heat_map')}}"/>
    <input type="hidden" id="getReportCallSentDestinationHeatMapDataURL" value="{{route('user.sms_reports.get_call_sent_destination')}}"/>
    <input type="hidden" id="getReportCampaignStatsDataURL" value="{{route('user.sms_reports.campagin_stats')}}"/>
    <input type="hidden" id="getReportListStatsDataURL" value="{{route('user.sms_reports.list_stats')}}"/>
    <input type="hidden" id="getReportRecordingStatsDataURL" value="{{route('user.sms_reports.recording_stats')}}"/>
    <input type="hidden" id="getReportCampaignRatioDataURL" value="{{route('user.sms_reports.campaign_ratio')}}"/>
    <input type="hidden" id="getCampaignSendRatesDataURL" value="{{route('user.sms_reports.campaign_send_rates')}}"/>
    <input type="hidden" id="getInboundCallDataURL" value="{{route('user.sms_reports.inbound_call_overtime')}}"/>
    <input type="hidden" id="getIvrOutboundCallDataURL" value="{{route('user.sms_reports.ivr_outbound_stats')}}"/>
    <input type="hidden" id="getOutboundOptinDataURL" value="{{route('user.sms_reports.outbound_optin_heatmap')}}"/>
    <input type="hidden" id="getIvrDncHeatmapDataURL" value="{{route('user.sms_reports.ivr_dnc_heatmap')}}"/>
    <input type="hidden" id="getDncHeatmapDataURL" value="{{route('user.sms_reports.dnc_heatmap')}}"/>
    <input type="hidden" id="getReportStateStatsDataURL" value="{{route('user.sms_reports.state_stats')}}"/>
    {{--
...
<script>
    ...
    async function fetchReportData(){
        ...
        .then((response) => {
            ...
            //     $('#inbound_sms_per_second').text(totalCalls);
            // }else{
            //     $('#inbound_sms_per_second').text(0);
            // }
            ...
            //     $('#outgoing_sms_per_second').text(totalCalls);
            // }else{
            //     $('#outgoing_sms_per_second').text(0);
            // }
        ...
        // am5.ready(function() {
            ...
            // https://www.amcharts.com/docs/v5/charts/xy-chart/#Setting_data
                ...
                .then((response) => {
                    ...
                    if(response.data.sendRatesPerDay !== null){

                        if(typeof response.data.sendRatesPerDay !== 'undefined' && response.data.sendRatesPerDay.length > 0){
                            response.data.sendRatesPerDay.forEach(element => {
...
async function optOutHeadMap(){

am4core.useTheme(am4themes_animated);
// Create map instance
var chart = am4core.create("opt-out-head-map", am4maps.MapChart);
// Set map definition
chart.geodata = am4geodata_usaLow;
...
async function optInHeadMap(){

am4core.useTheme(am4themes_animated);
// Create map instance
var chart = am4core.create("opt-in-head-map", am4maps.MapChart);
// Set map definition
chart.geodata = am4geodata_usaLow;
        ...
        if(response.data.campaginStats !== null && response.data.campaginStats.length > 0){
            ...
            Object.keys(response.data.campaginStats).forEach(function(key) {
                table.row.add( [
                    ...
                    response.data.campaginStats[key].sent_count + response.data.campaginStats[key].fail_count,
                    response.data.campaginStats[key].sent_count + '('+ response.data.campaginStats[key].sent_percentage + ')',
                    response.data.campaginStats[key].fail_count + '(' + response.data.campaginStats[key].failed_percentage + ')',
...
let baseUrl = $('#getReportRecordingStatsDataURL').val();
    ...
    let arr = [{"name":"List-VICI","campaign_type":"rvm","sent_count":14536,"fail_count":300,"calls_back_count":395,"avg_calls_duration":"25.8658227848101266","failed_percentage":"2.02","sent_percentage":"97.98"},{"name":"List(M4)","campaign_type":"rvm","sent_count":29400,"fail_count":300,"calls_back_count":606,"avg_calls_duration":"18.4636963696369637","failed_percentage":"1.01","sent_percentage":"98.99"},{"name":"List Press 1","campaign_type":"press-1","sent_count":29511,"fail_count":400,"calls_back_count":361,"avg_calls_duration":"14.4349030470914127","failed_percentage":"1.34","sent_percentage":"98.66"},{"name":"List","campaign_type":"rvm","sent_count":1285,"fail_count":500,"calls_back_count":65,"avg_calls_duration":"44.0000000000000000","failed_percentage":"28.01","sent_percentage":"71.99"},{"name":"List","campaign_type":"rvm","sent_count":221,"fail_count":600,"calls_back_count":6,"avg_calls_duration":"17.6666666666666667","failed_percentage":"73.08","sent_percentage":"26.92"},{"name":"List","campaign_type":"rvm","sent_count":82,"fail_count":240,"calls_back_count":5,"avg_calls_duration":"54.8000000000000000","failed_percentage":"74.53","sent_percentage":"25.47"},{"name":"List","campaign_type":"rvm","sent_count":17,"fail_count":440,"calls_back_count":0,"avg_calls_duration":null,"failed_percentage":"96.28","sent_percentage":"3.72"},{"name":"List","campaign_type":"rvm","sent_count":1191,"fail_count":340,"calls_back_count":103,"avg_calls_duration":"40.9708737864077670","failed_percentage":"22.21","sent_percentage":"77.79"},{"name":"List","campaign_type":"rvm","sent_count":568,"fail_count":343,"calls_back_count":17,"avg_calls_duration":"12.5882352941176471","failed_percentage":"37.65","sent_percentage":"62.35"},{"name":"List","campaign_type":"rvm","sent_count":2405,"fail_count":533,"calls_back_count":90,"avg_calls_duration":"30.6777777777777778","failed_percentage":"18.14","sent_percentage":"81.86"},{"name":"List","campaign_type":"rvm","sent_count":394,"fail_count":345,"calls_back_count":23,"avg_calls_duration":"47.7826086956521739","failed_percentage":"46.68","sent_percentage":"53.32"},{"name":"List","campaign_type":"rvm","sent_count":4236,"fail_count":765,"calls_back_count":123,"avg_calls_duration":"26.0569105691056911","failed_percentage":"15.30","sent_percentage":"84.70"},{"name":"List","campaign_type":"rvm","sent_count":1319,"fail_count":456,"calls_back_count":78,"avg_calls_duration":"27.0641025641025641","failed_percentage":"25.69","sent_percentage":"74.31"},{"name":"List","campaign_type":"rvm","sent_count":560,"fail_count":600,"calls_back_count":25,"avg_calls_duration":"21.6000000000000000","failed_percentage":"51.72","sent_percentage":"48.28"},{"name":"List","campaign_type":"rvm","sent_count":1253,"fail_count":1130,"calls_back_count":70,"avg_calls_duration":"40.3714285714285714","failed_percentage":"47.42","sent_percentage":"52.58"},{"name":"List","campaign_type":"rvm","sent_count":1805,"fail_count":345,"calls_back_count":799,"avg_calls_duration":"31.2803504380475594","failed_percentage":"16.05","sent_percentage":"83.95"},{"name":"List(M4)","campaign_type":"rvm","sent_count":49443,"fail_count":6543,"calls_back_count":1575,"avg_calls_duration":"22.3473015873015873","failed_percentage":"11.69","sent_percentage":"88.31"},{"name":"List Press 1","campaign_type":"press-1","sent_count":50019,"fail_count":7654,"calls_back_count":804,"avg_calls_duration":"18.0074626865671642","failed_percentage":"13.27","sent_percentage":"86.73"},{"name":"List 1","campaign_type":"press-1","sent_count":646559,"fail_count":200222,"calls_back_count":4605,"avg_calls_duration":"11.7791530944625407","failed_percentage":"23.65","sent_percentage":"76.35"},{"name":"List","campaign_type":"press-1","sent_count":303311,"fail_count":103201,"calls_back_count":6565,"avg_calls_duration":"14.8624523990860625","failed_percentage":"25.39","sent_percentage":"74.61"},{"name":"List","campaign_type":"rvm","sent_count":1279,"fail_count":200,"calls_back_count":35,"avg_calls_duration":"41.0857142857142857","failed_percentage":"13.52","sent_percentage":"86.48"},{"name":"List","campaign_type":"rvm","sent_count":222,"fail_count":30,"calls_back_count":6,"avg_calls_duration":"38.1666666666666667","failed_percentage":"11.90","sent_percentage":"88.10"}];
    ...
    Object.keys(arr).forEach((key) => {
        table.row.add( [
            arr[key].name,
            arr[key].sent_count + arr[key].fail_count,
            arr[key].sent_count + '('+ arr[key].sent_percentage + ')',
            arr[key].fail_count + '(' + arr[key].failed_percentage + ')',
    ...
    $('.campaignRatioLoader').show();
    loadStateSpecificStats();
}
function loadStateSpecificStats() {
    let dateRange = $('#dateRange').val();
    dateRange = dateRange.split(' - ');
    let startDate = dateRange[0];
    let endDate = dateRange[1];
    ...
    let arr = [{"name":"Alabama","campaign_type":"rvm","sent_count":14536,"fail_count":300,"calls_back_count":395,"avg_calls_duration":"25.8658227848101266","failed_percentage":"2.02","sent_percentage":"97.98"},{"name":"Alaska","campaign_type":"rvm","sent_count":29400,"fail_count":300,"calls_back_count":606,"avg_calls_duration":"18.4636963696369637","failed_percentage":"1.01","sent_percentage":"98.99"},{"name":"Arizona","campaign_type":"press-1","sent_count":29511,"fail_count":400,"calls_back_count":361,"avg_calls_duration":"14.4349030470914127","failed_percentage":"1.34","sent_percentage":"98.66"},{"name":"Arkansas","campaign_type":"rvm","sent_count":1285,"fail_count":500,"calls_back_count":65,"avg_calls_duration":"44.0000000000000000","failed_percentage":"28.01","sent_percentage":"71.99"},{"name":"California","campaign_type":"rvm","sent_count":221,"fail_count":600,"calls_back_count":6,"avg_calls_duration":"17.6666666666666667","failed_percentage":"73.08","sent_percentage":"26.92"},{"name":"Alabama","campaign_type":"rvm","sent_count":82,"fail_count":240,"calls_back_count":5,"avg_calls_duration":"54.8000000000000000","failed_percentage":"74.53","sent_percentage":"25.47"},{"name":"California","campaign_type":"rvm","sent_count":17,"fail_count":440,"calls_back_count":0,"avg_calls_duration":null,"failed_percentage":"96.28","sent_percentage":"3.72"},{"name":"Arkansas","campaign_type":"rvm","sent_count":1191,"fail_count":340,"calls_back_count":103,"avg_calls_duration":"40.9708737864077670","failed_percentage":"22.21","sent_percentage":"77.79"},{"name":"California","campaign_type":"rvm","sent_count":568,"fail_count":343,"calls_back_count":17,"avg_calls_duration":"12.5882352941176471","failed_percentage":"37.65","sent_percentage":"62.35"},{"name":"Alabama","campaign_type":"rvm","sent_count":2405,"fail_count":533,"calls_back_count":90,"avg_calls_duration":"30.6777777777777778","failed_percentage":"18.14","sent_percentage":"81.86"},{"name":"Delaware","campaign_type":"rvm","sent_count":394,"fail_count":345,"calls_back_count":23,"avg_calls_duration":"47.7826086956521739","failed_percentage":"46.68","sent_percentage":"53.32"},{"name":"Florida","campaign_type":"rvm","sent_count":4236,"fail_count":765,"calls_back_count":123,"avg_calls_duration":"26.0569105691056911","failed_percentage":"15.30","sent_percentage":"84.70"},{"name":"Florida","campaign_type":"rvm","sent_count":1319,"fail_count":456,"calls_back_count":78,"avg_calls_duration":"27.0641025641025641","failed_percentage":"25.69","sent_percentage":"74.31"},{"name":"List","campaign_type":"rvm","sent_count":560,"fail_count":600,"calls_back_count":25,"avg_calls_duration":"21.6000000000000000","failed_percentage":"51.72","sent_percentage":"48.28"},{"name":"List","campaign_type":"rvm","sent_count":1253,"fail_count":1130,"calls_back_count":70,"avg_calls_duration":"40.3714285714285714","failed_percentage":"47.42","sent_percentage":"52.58"},{"name":"List","campaign_type":"rvm","sent_count":1805,"fail_count":345,"calls_back_count":799,"avg_calls_duration":"31.2803504380475594","failed_percentage":"16.05","sent_percentage":"83.95"},{"name":"List(M4)","campaign_type":"rvm","sent_count":49443,"fail_count":6543,"calls_back_count":1575,"avg_calls_duration":"22.3473015873015873","failed_percentage":"11.69","sent_percentage":"88.31"},{"name":"List Press 1","campaign_type":"press-1","sent_count":50019,"fail_count":7654,"calls_back_count":804,"avg_calls_duration":"18.0074626865671642","failed_percentage":"13.27","sent_percentage":"86.73"},{"name":"List 1","campaign_type":"press-1","sent_count":646559,"fail_count":200222,"calls_back_count":4605,"avg_calls_duration":"11.7791530944625407","failed_percentage":"23.65","sent_percentage":"76.35"},{"name":"List","campaign_type":"press-1","sent_count":303311,"fail_count":103201,"calls_back_count":6565,"avg_calls_duration":"14.8624523990860625","failed_percentage":"25.39","sent_percentage":"74.61"},{"name":"List","campaign_type":"rvm","sent_count":1279,"fail_count":200,"calls_back_count":35,"avg_calls_duration":"41.0857142857142857","failed_percentage":"13.52","sent_percentage":"86.48"},{"name":"List","campaign_type":"rvm","sent_count":222,"fail_count":30,"calls_back_count":6,"avg_calls_duration":"38.1666666666666667","failed_percentage":"11.90","sent_percentage":"88.10"}];

    var table = $('#statesSpecificStatsTable').DataTable();
    var rows = table
        .rows()
        .remove()
        .draw();
    ...
    Object.keys(arr).forEach((key) => {
        table.row.add( [
            ...
            arr[key].sent_count + '('+ arr[key].sent_percentage + ')',
            arr[key].fail_count + '(' + arr[key].failed_percentage + ')',
            arr[key].calls_back_count,
            parseFloat(arr[key].avg_calls_duration).toFixed(2)

        ]).draw( false );
    });

    loadCarrierSpecificStats();
    $('.recordingSpecificStatsLoader').hide();
}
function loadCarrierSpecificStats() {
    let arr = [{"name":"Carrier1","campaign_type":"rvm","sent_count":14536,"fail_count":300,"calls_back_count":395,"avg_calls_duration":"25.8658227848101266","failed_percentage":"2.02","sent_percentage":"97.98"},{"name":"Carrier2","campaign_type":"rvm","sent_count":29400,"fail_count":300,"calls_back_count":606,"avg_calls_duration":"18.4636963696369637","failed_percentage":"1.01","sent_percentage":"98.99"},{"name":"Carrier3","campaign_type":"press-1","sent_count":29511,"fail_count":400,"calls_back_count":361,"avg_calls_duration":"14.4349030470914127","failed_percentage":"1.34","sent_percentage":"98.66"},{"name":"Signal Wire","campaign_type":"rvm","sent_count":1285,"fail_count":500,"calls_back_count":65,"avg_calls_duration":"44.0000000000000000","failed_percentage":"28.01","sent_percentage":"71.99"},{"name":"Carrier4","campaign_type":"rvm","sent_count":221,"fail_count":600,"calls_back_count":6,"avg_calls_duration":"17.6666666666666667","failed_percentage":"73.08","sent_percentage":"26.92"},{"name":"Carrier1","campaign_type":"rvm","sent_count":82,"fail_count":240,"calls_back_count":5,"avg_calls_duration":"54.8000000000000000","failed_percentage":"74.53","sent_percentage":"25.47"},{"name":"Carrier4","campaign_type":"rvm","sent_count":17,"fail_count":440,"calls_back_count":0,"avg_calls_duration":null,"failed_percentage":"96.28","sent_percentage":"3.72"},{"name":"Signal Wire","campaign_type":"rvm","sent_count":1191,"fail_count":340,"calls_back_count":103,"avg_calls_duration":"40.9708737864077670","failed_percentage":"22.21","sent_percentage":"77.79"},{"name":"Carrier4","campaign_type":"rvm","sent_count":568,"fail_count":343,"calls_back_count":17,"avg_calls_duration":"12.5882352941176471","failed_percentage":"37.65","sent_percentage":"62.35"},{"name":"Carrier1","campaign_type":"rvm","sent_count":2405,"fail_count":533,"calls_back_count":90,"avg_calls_duration":"30.6777777777777778","failed_percentage":"18.14","sent_percentage":"81.86"},{"name":"Delaware","campaign_type":"rvm","sent_count":394,"fail_count":345,"calls_back_count":23,"avg_calls_duration":"47.7826086956521739","failed_percentage":"46.68","sent_percentage":"53.32"},{"name":"Florida","campaign_type":"rvm","sent_count":4236,"fail_count":765,"calls_back_count":123,"avg_calls_duration":"26.0569105691056911","failed_percentage":"15.30","sent_percentage":"84.70"},{"name":"Florida","campaign_type":"rvm","sent_count":1319,"fail_count":456,"calls_back_count":78,"avg_calls_duration":"27.0641025641025641","failed_percentage":"25.69","sent_percentage":"74.31"},{"name":"List","campaign_type":"rvm","sent_count":560,"fail_count":600,"calls_back_count":25,"avg_calls_duration":"21.6000000000000000","failed_percentage":"51.72","sent_percentage":"48.28"},{"name":"List","campaign_type":"rvm","sent_count":1253,"fail_count":1130,"calls_back_count":70,"avg_calls_duration":"40.3714285714285714","failed_percentage":"47.42","sent_percentage":"52.58"},{"name":"List","campaign_type":"rvm","sent_count":1805,"fail_count":345,"calls_back_count":799,"avg_calls_duration":"31.2803504380475594","failed_percentage":"16.05","sent_percentage":"83.95"},{"name":"List(M4)","campaign_type":"rvm","sent_count":49443,"fail_count":6543,"calls_back_count":1575,"avg_calls_duration":"22.3473015873015873","failed_percentage":"11.69","sent_percentage":"88.31"},{"name":"List Press 1","campaign_type":"press-1","sent_count":50019,"fail_count":7654,"calls_back_count":804,"avg_calls_duration":"18.0074626865671642","failed_percentage":"13.27","sent_percentage":"86.73"},{"name":"List 1","campaign_type":"press-1","sent_count":646559,"fail_count":200222,"calls_back_count":4605,"avg_calls_duration":"11.7791530944625407","failed_percentage":"23.65","sent_percentage":"76.35"},{"name":"List","campaign_type":"press-1","sent_count":303311,"fail_count":103201,"calls_back_count":6565,"avg_calls_duration":"14.8624523990860625","failed_percentage":"25.39","sent_percentage":"74.61"},{"name":"List","campaign_type":"rvm","sent_count":1279,"fail_count":200,"calls_back_count":35,"avg_calls_duration":"41.0857142857142857","failed_percentage":"13.52","sent_percentage":"86.48"},{"name":"List","campaign_type":"rvm","sent_count":222,"fail_count":30,"calls_back_count":6,"avg_calls_duration":"38.1666666666666667","failed_percentage":"11.90","sent_percentage":"88.10"}];

    var table = $('#carrierSpecificStatsTable').DataTable();
    var rows = table
        .rows()
        .remove()
        .draw();
