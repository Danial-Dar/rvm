    ...
    <nav class="navbar navbar-light">
        <div class="navbar-left">
            <a href="" class="sidebar-toggle">
                ...
                <!-- <img class="svg" src="{{ asset('img/svg/logos.png') }}" alt="img"> -->
            </a>
            <a class="navbar-brand" href="">
                <img class="dark" src="{{ asset('img/svg/'.$img) }}" alt="" style="margin-top: 3%; margin-left: 5%;">
        ...
        <div class="navbar-right">
            <ul class="navbar-right__menu">
                ...
                <li class="nav-author">
                    <div class="dropdown-custom">
                       {{--  <?php
                            $profileImagePath = storage_path() . '/images/' .auth()->user()->user_image;
                        ?> --}}
                        <a href="javascript:;" class="nav-item-toggle">
                           {{--  @if(auth()->user()->user_image && file_exists($profileImagePath))
                                <img src="{{ url('user/image') }}" alt="" class="rounded-circle">
                            @else
                            <img src="{{ asset('img/author-nav.jpg') }}" alt="" class="rounded-circle">
                            @endif --}}
                            <img src="{{ asset('img/profile_image.png') }}" alt="" class="rounded-circle">
                        </a>
                        <div class="dropdown-wrapper">
