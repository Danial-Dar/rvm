            ...
            <div class="col-lg-12">
                <div class="breadcrumb-main user-member justify-content-sm-between ">
                    ...
                    <div class="userDatatable global-shadow border p-30 bg-white radius-xl w-100 mb-30">
                        ...
                        <input type="hidden" id="billingURL" value="{{url('user/billing/')}}">
                        <input type="hidden" id="billingDataURL" value="{{route('user.billing.get_billing_data')}}">
                        <input type="hidden" id="smsbillingURL" value="{{url('user/sms/billing/')}}">
                        <input type="hidden" id="smsbillingDataURL" value="{{route('user.sms.billing.get_billing_data')}}">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4 mb-20">
                                ...
                                <input type="text" name="datetimes" id="dateRange" class="form-control" onchange="companyFunction();smsBillingFunction()"/>
                             </div>
...
<script>
        ...
        params: {
            ...
            if(response.data){
                ...
                table2.row.add( [
                    ...
                    totalCIRCount,
                    currencyFormatter.format(parseFloat('0'+totalCIRPricSum).toFixed(2))
    ...
    async function smsBillingFunction(){
