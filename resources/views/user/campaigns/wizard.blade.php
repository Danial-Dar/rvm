...
<div class="contents" style="padding-top: 120px !important;">
    <form id="campaignAddForm" action="{{route('user.campaign.store')}}" method="post" enctype="multipart/form-data" style="padding: 10px 10px 10px 10px;" onsubmit="loader()">
        @csrf
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="row mt-20" id="bot_dropdown" style="display:none;">
                            <div class="col-md-12">
                                <div class="form-group mb-20">
                                    <select name="bot_type" id="bot_type" class="form-control" onchange="$('#bot_dropdown').find('button').removeClass('border-error')"></select>
                                </div>
                            </div>
                        </div>
                        ...
                        {{-- <div class="row" id="random_content" style="display: none;">
                            <div class="form-group mb-20 px-3">
                              ...
                              style="" value="" onkeyup="$('#caller_id_random').val() !== '' ? $('#caller_id_random').removeClass('border-error') : $('#caller_id_random').addClass('border-error')">
                           </div>
                        </div> --}}
                        {{-- caller id end --}}
                        ...
                        <div class="row" id="ci_forward_number_content">
                            <div class="col-12">
                                <div class="form-group mb-20">
                                    ...
                                    class="form-control mask_input" required onkeyup="$('#ci_forward_number').val() !== '' ? $('#ci_forward_number').removeClass('border-error') : $('#ci_forward_number').addClass('border-error')">
                                </div>
                            </div>
                        </div>
                        <label id="vm_forward_number_label">Voice Mail Forward To Number</label>
                        <div class="row" id="vm_forward_number_content">
                            <div class="col-12">
                                <div class="form-group mb-20">
                                    ...
                                    required onkeyup="$('#vm_forward_number').val() !== '' ? $('#vm_forward_number').removeClass('border-error') : $('#vm_forward_number').addClass('border-error')">
                                </div>
                            </div>
                        </div>
                        {{-- forward number end --}}
            ...
            <div class="row setup-content" id="step-3">
                <div class="col-md-12">
                    <div class="col-md-12">
                        ...
                        <div class="action-btn">
                            <a href="#" class="btn px-15 btn-primary"  data-toggle="modal" data-target="#add_recording_modal">
                        ...
                        <div class="mt-20" id="optoutRecordingContent" style="display: none;">
                        ...
                        <div class="mt-20" id="optinRecordingContent" style="display: none;">
                            ...
                            <div class="action-btn">
                                <a href="#" class="btn px-15 btn-primary"  data-toggle="modal" data-target="#add_optin_recording_modal">
                                  <i class="las la-plus fs-16"></i>Upload New Optin Recording</a>
                                 {{-- loader model --}}
                               <div class="modal fade" id="loader-modal-optin-recording" tabindex="-1" role="dialog" aria-labelledby="loader_modalTitle" aria-hidden="true">
                                  <div class="modal-dialog modal-dialog-centered modal-md" role="document">
                                    <div class="modal-content">
                                      <div class="modal-header">
                                        <h5 class="modal-title" id="exampleModalLongTitle">Your Optin Recording Is Adding</h5>
                                      </div>
                                      <div class="modal-body text-center" style="padding: 20px 75px 20px 75px">
                                          <div class="spinner-border text-info spin"></div>
                                          <div id='seconds-counter-optin-recording'> </div>
                                      </div>
                                    </div>
                                  </div>
                               </div>
                ...
                <div class="col-md-12">
                    <div class="col-md-12">
                        ...
                        <div class="form-group mb-20 ml-20 mt-20">
                            ...
                            <button type="button" onclick="$('#campaignAddForm').submit();"  class="btn btn-primary mr-20">Send Now</button>
...
<div class="modal fade" id="add_recording_modal" tabindex="-1" role="dialog" aria-labelledby="add_recording_modalTitle" aria-hidden="true">
  ...
  {{-- optin recording modal --}}
  <div class="modal fade" id="add_optin_recording_modal" tabindex="-1" role="dialog" aria-labelledby="add_optin_recording_modalTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLongTitle">Add Optin Recording</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body" style="padding: 20px 75px 20px 75px">
                <form action="" id="optinRecordingCampaignForm" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="form-group mb-20">
                        <label for="">Recording Name</label>
                        <input type="text" name="name" id="optinRecordingCampaignFormName"
                        style="border: 1px solid #ced4da !important;" class="form-control"
                        placeholder="Recording Name" required>
                    </div>
                    <div class="form-group mb-20">
                        <label for="recording">Upload Recording</label>
                        <input type="file" name="file" id="optinRecordingCampaignFormFile"
                        style="border: 1px solid #ced4da !important;" class="form-control"
                        required accept=".mp3,.wav">
                    </div>


                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                        <button type="button" onclick="addOptinRecording(event)" class="btn btn-primary">Add Recording</button>
                    </div>
                </form>
            </div>
        </div>
...
<input type="hidden" id="validateContactListCsvUrl" value="{{route('user.contact-list.validate_csv')}}">
...
<script type="text/javascript">
    $(document).ready(function(){
      ...
      $('#alert-danger').delay(3000).fadeOut();
        ...
        $('INPUT[id="optinRecordingCampaignFormFile"]').change(function () {
            var ext = this.value.match(/\.(.+)$/)[1];
            switch (ext) {
                case 'mp3':
                case 'wav':
        ...
        $('INPUT[id="optoutRecordingCampaignFormFile"]').change(function () {
            var ext = this.value.match(/\.(.+)$/)[1];
            switch (ext) {
                case 'mp3':
                case 'wav':
            ...
            if(OptoutRecordingFlag === false){
                ...
                success: function (response) {
                    ...
                    if(response.length >0){
                        ...
                        $('#optout_recording').append('<option disabled  Selected>0 recording available</option>');
                    }
        ...
        // -------------- fetch all optin recordings  ----------------
        let OptinRecordingSelect = $('#optinRecordingContent button');
        let OptinRecordingFlag = false;

        OptinRecordingSelect.click(function(){
            $('#optinRecordingContent').find('button').removeClass("border-error");
            if(OptinRecordingFlag === false){
                $('.recording-loader').remove();
                recordingSelect.append('<div class="recording-loader spinner-border spinner-border-sm"></div>');
                $.ajax({
                type: 'GET',
                ...
                url: $('#getAllRecordingsURL').val(),
                success: function (response) {
                    OptinRecordingFlag = true;

                    if(response.length >0){
                        $('#optin_recording').empty();
                        $('#optin_recording').append('<option disabled  Selected>Click to select optin Recording for RVM</option>');
                        for(let i=0;i<response.length;i++){
                            $('#optin_recording').append('<option value="'+response[i].id+'">'+response[i].name+'</option>')

                        }
                    }else{
                        alert('0 recording found.');
                    }
                    $('#optin_recording').selectpicker('refresh');
                    console.log('Recording loaded successful.');
                },
                beforeSend: function(){
                    $('.recording-loader').show()
...
function fetchBotData(value){
    ...
    if(value ==="press-1"){
        ...
        // $('#alpha').hide();
        // $('#alpha_notes').hide();
        $('#optinRecordingContent').show();
        $('#optout_recording').attr('required', true);
        $('#optin_recording').attr('required', true);
        $('#vm_forward_number_label').hide();
        $('#vm_forward_number_content').hide();
        $('#vm_forward_number').attr('required', false);
    }
    else{
        ...
        $('#optinRecordingContent').hide();
        $('#optin_recording').attr('required', false);

        $('#vm_forward_number_label').show();
        $('#vm_forward_number_content').show();
        $('#vm_forward_number').attr('required', true);
    }
}
...
//  }
 ...
 function testApiCallModal(){
  ...
  function checkTestCall(e){
    ...
    function optinRecordingLoader()
    {
      $('#loader-modal-optin-recording').modal({
            backdrop: 'static',
            keyboard: false
        });
        // $('.spin').show();
        $('#add_optin_recording_modal').modal('hide');
        $('#loader-modal-optin-recording').modal('show');
    ...
    function addOptinRecording(e)
    {
        e.preventDefault();
        if($( '#optinRecordingCampaignFormName' ).val() === '')
        {
            alert('Name is required');
            return;
        }

        if($('#optinRecordingCampaignFormFile' )[0].files.length === 0){
            alert('File is required');
            return;
        }
        optinRecordingLoader();
        let ajaxData = new FormData();
        ajaxData.append( 'name', $( '#optinRecordingCampaignFormName' ).val());
        ajaxData.append( 'file', $( '#optinRecordingCampaignFormFile' )[0].files[0]);
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                $('#optinRecordingCampaignFormName' ).val('');
                $('#optinRecordingCampaignFormFile' ).val('');

                setTimeout(function () {
                    $('#loader-modal-optin-recording').modal('hide');
                }, 1000);

                $('#optin_recording').append('<option Selected disabled>Click to select optin Recording for RVM</option>');
                var response = data['recording'];
                if(response !== null){
                    for(let i=0;i<response.length;i++){
                        $('#optin_recording').append('<option value="'+response[i].id+'">'+response[i].name+'</option>')
                ...
                $('#optin_recording').selectpicker('refresh');
                console.log('Optin Recording added successfully.');
                // console.log(data);
                $('#add_optin_recording_modal').modal('hide');
            },
            error: function (data) {
