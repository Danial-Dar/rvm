...
class FailStatusCir extends Value
{
    // public $icon = 'play';
    public $name = 'Fair Status';

    public $helpText="Shows the fair number of cell-numbers monitored.";
    ...
    public function calculate(NovaRequest $request)
    {
        ...
        return $this->result(
            ($fair_count/($monitored_count?$monitored_count:1) * 100)
        )->suffix('%');
