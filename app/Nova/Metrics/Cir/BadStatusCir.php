...
class BadStatusCir extends Value
{
     public $icon = 'thumb-down';
     public $name = 'Bad Status';

     public $helpText="Shows the bad number of cell-numbers monitored.";
     ...
     public function calculate(NovaRequest $request)
     {
         ...
         return $this->result(
             ($bad_count/($monitored_count?$monitored_count:1) * 100)
         )->suffix('%');
