...
class CallFlowNumber extends Resource
{
    /**
     ...
     * @var string
     */
    public static $model = \App\Models\CallFlowNumber::class;
     ...
     * @var string
     */
    public static $title = 'friendly_name';
    ...
    public static function additionalButtons(){
        if(request()->user()){
            ...
            //     return [['component' => 'PurchaseCallNumber'], ['component' => 'PurchaseNumber']];
            // }
            ...
            // return [['component' => 'PurchaseNumber']];
            // }
            if (request()->user()->can('purchase-call-flow-number')) {
                return [['component' => 'PurchaseCallNumber']];
            }
