...
class Badge extends Field
{
    ...
    public function resolveBadgeClasses()
    {
        ...
        if (! isset($this->types[$mappedValue])) {
            throw new Exception("Error trying to find type [{$this->attribute}] inside of the field's type mapping.");
        }
    ...
    public function resolveLabel()
    {
        ...
        return $this->labels[$this->value] ?? ($this->value == 'played' ? 'playing' : $this->value );
    }
