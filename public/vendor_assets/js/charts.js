...
function chartjsBarChartCashflowExtra(selector, dataCIn, DataCOut, labels, max=50, stepSize = 5, label = "Forms Completed") {
  var ctx = document.getElementById(selector);
  console.log(max)
  Chart.defaults.global.defaultFontColor = "#868EAE";
  if (ctx) {
...
/* Bar chart two */
function chartjsBarChartTwo(selector, label = "Bar chart one", processing, pending, completed) {
  var ctx = document.getElementById(selector);
  if (ctx) {
    ctx.getContext("2d");
    var chart = new Chart(ctx, {
...
function chartjsBarChartMulti(selector, label = "Bar chart one", labels, total_amount, total_refund_amount, max, stepSize) {
  var ctx = document.getElementById(selector);
  if (ctx) {
    ctx.getContext("2d");
    var chart = new Chart(ctx, {
